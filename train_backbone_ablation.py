...
if __name__ == "__main__":
    ...
    grid_many_branches = {
        ...
        "data_args": {"dataset": ["cifar100"], "subset_ratio": [1.0], "train": [True]},
    }
    ...
    grid_one_branch = {
        ...
        "model_args": {
            ...
            "kwargs": {
                "filter_config": [[3, 32, 64, 128]],
                "input_config": [[3, 32, 32]],
                "latent_config": {"n_branches": [1], "out_features_branch": [160]},
            },
        },
        "data_args": {"dataset": ["cifar100"], "subset_ratio": [1.0], "train": [True]},
    }
    ...
    grids = {
        "grid_one_branch": grid_one_branch,
        "grid_many_branches": grid_many_branches,
    }
