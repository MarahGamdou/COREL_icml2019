...
def main():
    ...
    eval_config_grid = {
        "dataset": [
            "cifar10"
        ],  # , 'cifar20', 'cifar100', 'tiny-imagenet-200', 'ImageNet'],
        "n_train_samples": [80, 120, 500],
        "scorer": {
            "id": ["CountScorerProduct"],
            "kwargs": {"aggregation": ["sum"], "truncation_radius": [2.0]},
        },
        "n_runs": [5],
    }
    ...
    evaluate_backbones_on_eval_config_grid(
        ROOT_FOLDER, eval_config_grid, OUT_FOLDER, device=device
    )
